...
from main_app.validators import ValidateMenuCategories, validate_menu_categories


class RestaurantMenuMixin(models.Model):
...
class RestaurantReview(RestaurantMenuMixin):
    ...
    class Meta(RestaurantMenuMixin.Meta):
        abstract = True
        # ordering = ('-rating',)
...
class MenuReview(RestaurantMenuMixin):
    reviewer_name = models.CharField(
        max_length=100,
    )
